...
Fu_max=500; Fv_max=500; Fr_max=500; v_smax=100; v_smin=-100;
...
q11=1e5; q22=1e5; q33=1e3; q44=1e3; q55=1e-3; q66=1e-3; q77=1e-3;
Q1=diag([q11,q22,q33,q44,q55,q66,q77]);

r11=1e-3; r22=1e-3; r33=1e-3; r44=1e-3;
R1=diag([r11,r22,r33,r44]);

qf11=1e2; qf22=1e2; qf33=1e1; qf44=1e2; qf55=1e-3; qf66=1e-3; qf77=1e-3;
Qf1=diag([qf11,qf22,qf33,qf44,qf55,qf66,qf77]);

%==========================================================================
% Weighting Matrices for Priority 2
q11_p2=1e4; q22_p2=1e4; q33_p2=1e2; q44_p2=1e3; q55_p2=1e-3; q66_p2=1e-3;
q77_p2=1e3;
Q_prio2=diag([q11_p2,q22_p2,q33_p2,q44_p2,q55_p2,q66_p2,q77_p2]);


r11_p2=1e-3; r22_p2=1e-3; r33_p2=1e-3; r44_p2=1e-3;
R_prio2=diag([r11_p2,r22_p2,r33_p2,r44_p2]);

qf11_p2=1e2; qf22_p2=1e2; qf33_p2=1e1; qf44_p2=1e2; qf55_p2=1e-3;
qf66_p2=1e-3; qf77_p2=1e2;
...
lomompc = MPC_controller(N,internal_model,weights,Umax0,Umin0);
u0 = zeros(nu*N,1);
...
for i=1:1:Tstep
    ...
    tic
    [u,J2_star] = lomompc.calc_control2(J1_star,epsi,zeta_plus,X0,u0,dt);
    toc
    J2all(i) = J2_star;
    ...
    rrd1_prev = (px_dot(ZETAall(1,i))^2+py_dot(ZETAall(1,i))^2)*(px_dot(ZETAall(1,i))*py_dddot(ZETAall(1,i)))-2*(px_dot(ZETAall(1,i))*py_ddot(ZETAall(1,i))-py_dot(ZETAall(1,i))*px_ddot(ZETAall(1,i)))*(px_dot(ZETAall(1,i))*px_ddot(ZETAall(1,i))+py_dot(ZETAall(1,i))*py_ddot(ZETAall(1,i)));
    ...
    epsi0 = Xaug_prev_tilde'*Q1*Xaug_prev_tilde + Uaug_prev_tilde'*R1*Uaug_prev_tilde - Xaug_tilde'*Qepsi*Xaug_tilde;
    if epsi0 > epsi_max
        epsi1 = epsi_max;
    else
        epsi1 = epsi0;
