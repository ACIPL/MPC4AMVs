function [ y,ceq ] = yaw_constraints( u,X0,Hp,Lambda,Kp,Kd,t,Fu_pred,Fv_pred,T)
...
nFv_pred=length(Fv_pred);
nFv_pred=nFv_pred/Hp;
Fv_partitioned=zeros(nFv_pred,Hp);
...
for i=1:1:Hp
    for j=1:1:nFv_pred
        ...
        Fv_partitioned(j,i)=Fv_pred((i-1)*nFv_pred+j,1);
...
for i=1:1:Hp
    ...
    tau = [Fu_partitioned(:,i);Fv_partitioned(:,i);U(:,i)];
    Tau(:,i) = tau;
