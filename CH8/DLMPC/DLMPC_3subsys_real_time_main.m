...
max_iter = N*50;
allowed_processing_time = 0.1;
delta_iter = 2*N;
ELAPSE=zeros(1,Tstep2);
minimum_allowed_N = 3;
minimum_allowed_max_iter = 10;
for i=1:1:Tstep2
 ...
 %=========================================================================
    elapsed_time = toc;
    if elapsed_time > allowed_processing_time
        max_iter = max(max_iter - delta_iter, minimum_allowed_max_iter);
        options = optimset('Algorithm','sqp', 'MaxIter', max_iter );
    elseif elapsed_time < alpha * allowed_processing_time
        max_iter = max(max_iter + delta_iter, minimum_allowed_max_iter);
        options = optimset('Algorithm','sqp', 'MaxIter', max_iter );
    end  
    
    if (max_iter < (2*N^2 + 2*N) && N > minimum_allowed_N)
        N = max(N-1, minimum_allowed_N)
        max_iter=N*50;
        delta_iter = 2*N;
        options = optimset('Algorithm','sqp', 'MaxIter', max_iter );
        u0_surge = u0_surge(1:N);
        X_assumed = X_assumed(:,1:N);
...
% hold on;
plot(Xall2(1,1:Tstep2),Xall2(2,1:Tstep2),'c','LineWidth',2);
hold on;
...
% hold on;
plot(TIme(1:Tstep2,1),Uall2(1,1:Tstep2),'c','LineWidth',2);
hold on;

subplot(3,1,2)
% plot(TIme(1:Tstep2,1),Uall(2,1:Tstep2),'b');
% hold on;
plot(TIme(1:Tstep2,1),Uall2(2,1:Tstep2),'c','LineWidth',2);
hold on;

subplot(3,1,3)
% plot(TIme(1:Tstep2,1),Uall(3,1:Tstep2),'b');
% hold on;
plot(TIme(1:Tstep2,1),Uall2(3,1:Tstep2),'c','LineWidth',2);
hold on;
%==========================================================================
%                        Plot Thrusts
%==========================================================================
...
% hold on;
plot(TIme(1:Tstep2,1),Thrust_all2(1,1:Tstep2),'c','LineWidth',2);
hold on;

subplot(4,1,2)
% plot(TIme(1:Tstep2,1),Thrust_all(2,1:Tstep2),'b');
% hold on;
plot(TIme(1:Tstep2,1),Thrust_all2(2,1:Tstep2),'c','LineWidth',2);
hold on;

subplot(4,1,3)
% plot(TIme(1:Tstep2,1),Thrust_all(3,1:Tstep2),'b');
% hold on;
plot(TIme(1:Tstep2,1),Thrust_all2(3,1:Tstep2),'c','LineWidth',2);
hold on;
 
subplot(4,1,4)
% plot(TIme(1:Tstep2,1),Thrust_all(4,1:Tstep2),'b');
% hold on;
plot(TIme(1:Tstep2,1),Thrust_all2(4,1:Tstep2),'c','LineWidth',2);
hold on;
...
% hold on;
grid on;
plot(TIme(1:Tstep2,1),Xall2(1,1:Tstep2),'c','LineWidth',2);
hold on;
...
% hold on;
grid on;
plot(TIme(1:Tstep2,1),Xall2(2,1:Tstep2),'c','LineWidth',2);
hold on;
...
% hold on;
grid on;
plot(TIme(1:Tstep2,1),Xall2(3,1:Tstep2),'c','LineWidth',2);
hold on;
...
% hold on;
grid on;
plot(TIme(1:Tstep2,1),Xall2(4,1:Tstep2),'c','LineWidth',2);
hold on;
...
% hold on;
grid on;
plot(TIme(1:Tstep2,1),Xall2(5,1:Tstep2),'c','LineWidth',2);
hold on;
...
% hold on;
grid on;
plot(TIme(1:Tstep2,1),Xall2(6,1:Tstep2),'c','LineWidth',2);
hold on;

ALLOWED_PROCESSING_TIME = ones(1,Tstep2);
ALLOWED_PROCESSING_TIME = ALLOWED_PROCESSING_TIME*allowed_processing_time;
figure(6)
plot(ALLOWED_PROCESSING_TIME(1,1:Tstep2),'r','LineWidth',2);
grid on;
hold on;
plot(ELAPSE(1,1:Tstep2),'c','LineWidth',2);
grid on;
hold on;
