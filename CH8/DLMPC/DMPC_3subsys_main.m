...
for i=1:1:Tstep2
    ...
    tic;
    u = fmincon(@(u) surge_cost_2( u,Xplus,N,Q,Qf,R,P,X_assumed,T),u0_surge,[],[],[],[],Fumin,Fumax,[],options);     
    Fu_pred2 = u;
    
    u = fmincon(@(u) sway_cost_2( u,Xplus,N,Q,Qf,R,P,X_assumed,T),u0_sway,[],[],[],[],Fvmin,Fvmax,[],options);  
    Fv_pred2 = u;
    
    u = fmincon(@(u) yaw_cost_2( u,Xplus,N,Q,Qf,R,P,X_assumed,T),u0_yaw,[],[],[],[],Frmin,Frmax,[],options); 
    Fr_pred2 = u;
...
hold on;
plot(Xall2(1,1:Tstep2),Xall2(2,1:Tstep2),'m','LineWidth',2);
hold on;
%==========================================================================
...
% hold on;
plot(TIme(1:Tstep2,1),Uall2(1,1:Tstep2),'m','LineWidth',2);
hold on;

subplot(3,1,2)
% plot(TIme(1:Tstep2,1),Uall(2,1:Tstep2),'b');
% hold on;
plot(TIme(1:Tstep2,1),Uall2(2,1:Tstep2),'m','LineWidth',2);
hold on;

subplot(3,1,3)
% plot(TIme(1:Tstep2,1),Uall(3,1:Tstep2),'b');
% hold on;
plot(TIme(1:Tstep2,1),Uall2(3,1:Tstep2),'m','LineWidth',2);
hold on;
...
% hold on;
plot(TIme(1:Tstep2,1),Thrust_all2(1,1:Tstep2),'m','LineWidth',2);
hold on;

subplot(4,1,2)
% plot(TIme(1:Tstep2,1),Thrust_all(2,1:Tstep2),'b');
% hold on;
plot(TIme(1:Tstep2,1),Thrust_all2(2,1:Tstep2),'m','LineWidth',2);
hold on;

subplot(4,1,3)
% plot(TIme(1:Tstep2,1),Thrust_all(3,1:Tstep2),'b');
% hold on;
plot(TIme(1:Tstep2,1),Thrust_all2(3,1:Tstep2),'m','LineWidth',2);
hold on;

subplot(4,1,4)
% plot(TIme(1:Tstep2,1),Thrust_all(4,1:Tstep2),'b');
% hold on;
plot(TIme(1:Tstep2,1),Thrust_all2(4,1:Tstep2),'m','LineWidth',2);
hold on;
...
% hold on;
% grid on;
plot(TIme(1:Tstep2,1),Xall2(1,1:Tstep2),'m','LineWidth',2);
hold on;
...
% hold on;
% grid on;
plot(TIme(1:Tstep2,1),Xall2(2,1:Tstep2),'m','LineWidth',2);
hold on;
...
% hold on;
% grid on;
plot(TIme(1:Tstep2,1),Xall2(3,1:Tstep2),'m','LineWidth',2);
hold on;
...
% hold on;
% grid on;
plot(TIme(1:Tstep2,1),Xall2(4,1:Tstep2),'m','LineWidth',2);
hold on;
...
% hold on;
% grid on;
plot(TIme(1:Tstep2,1),Xall2(5,1:Tstep2),'m','LineWidth',2);
hold on;
...
% hold on;
% grid on;
plot(TIme(1:Tstep2,1),Xall2(6,1:Tstep2),'m','LineWidth',2);
hold on;
